...
export const GlowCard: React.FC<GlowCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden rounded-[2rem] border border-slate-205/60 bg-white/60 p-8 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.01)] transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:border-slate-350/80 group ${className}`}
    >
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(500px circle at ${smoothX}px ${smoothY}px, ${glowColor}, transparent 80%)`,
        }}
      />
