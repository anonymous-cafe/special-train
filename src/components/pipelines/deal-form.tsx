...
export function DealForm({
  ...
  useEffect(() => {
    ...
    if (deal) {
      ...
      setValue("");
      setCurrency("USD");
      const initialStage = stages.find((s) => s.id === (defaultStageId || stages[0]?.id));
      setProbability(String(initialStage?.default_probability ?? 20));
      setContactId("");
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-[1fr_100px_110px]">
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <Input type="number" min={0} max={100} value={probability} onChange={(e) => setProbability(e.target.value)} className="border-slate-700 bg-slate-800 pr-6 text-white" />
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (nextStage?.default_probability != null) {
                    setProbability(String(nextStage.default_probability));
                  }
                }}
                className="h-9 w-full rounded-lg border border-slate-700 bg-slate-800 px-2.5 text-sm text-white outline-none focus:border-primary"
              >
