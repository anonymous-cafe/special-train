...
export const metadata: Metadata = {
  title: {
    default: "GrowthSprint365 — WhatsApp CRM",
    template: "%s — GrowthSprint365",
  },
  description: "GrowthSprint365 is a WhatsApp-first CRM for sales, support, broadcasts, automations, pipelines and AI-assisted customer engagement.",
  ...
  openGraph: {
    title: "GrowthSprint365 — WhatsApp CRM",
    description: "Turn WhatsApp conversations into organized sales and support workflows.",
    type: "website",
  },
  icons: {
    icon: [{ url: "/icon" }],
