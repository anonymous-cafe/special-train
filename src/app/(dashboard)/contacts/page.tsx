...
export default function ContactsPage() {
  ...
  // Global Search can deep-link to one contact. Reading the query string
  // directly avoids making this otherwise-static page depend on
  // useSearchParams/Suspense during the production build.
  useEffect(() => {
    const deepLinkContactId = new URLSearchParams(window.location.search).get('contact');
    if (!deepLinkContactId || lastDeepLinkRef.current === deepLinkContactId) return;
    lastDeepLinkRef.current = deepLinkContactId;
    queueMicrotask(() => {
