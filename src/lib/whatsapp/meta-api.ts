...
/**
 * Send a WhatsApp media message from a public HTTPS URL. This deliberately
 * uses Meta's link-based media payload so the CRM can keep a reusable media
 * library without implementing binary upload/storage in the app itself.
 */
